players = [
    ...
    ("Itwabosballss", ["@Picklehi27GD", "", "", "A random victor of Shitty Andromeda on YouTube."], [], []),
    ("Panzer", ["@TheRealPanzer", "", "", "A random victor of Shitty Andromeda on YouTube."], [], []),
    ("minhmnvnnet", ["@minhmnvnnet", "", "", "A random victor of Shitty Andromeda on YouTube."], [], []),
    ("Loliquiem", ["@loliquiemgd", "", "", "A random victor of Shitty Andromeda on YouTube."], [], []),
    ("Ylissen", ["@Ylissen", "🇲🇦", "", "A friend and the top 4 Morocco player on Global List (la dash orbe noire)"], [], [])
]
