challenges_list_top: list[tuple[str, str, str, str, dict[str, str]]] = [
    ...
    ("Shitty Endless River", "127610296", "X5 River's part from Shitty Slaughterhouse + ending verified by Roxy", "", {"Roxy": "78VvdYYHg6I", "Uranium": "MVpXlyuSz1o", "Minhmnvnnet": "3lRV889CUCA"}),
