players: list[tuple[str, list[str], list[str], list[str]]] = [
    ...
    ("Ghosted", ["@FireCyan803", "Unknown", "", "A person probably"], [], []),
    ("Ultravoilet", ["@Ultraviolet977", "Unknown", "", "A person probably"], [], []),
    ...
    ("AuguXD", ["@wasuretalover", "CL", "", "A player from Chile. Hardest: Wasureta asa jump from Connect"], [], []),
