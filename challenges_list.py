challenges_list_top: list[tuple[str, str, str, str, dict[str, str]]] = [
    ...
    ("Cube Challenge", "123317744", "A level built for the challenge swap with Ylissen. We has 10 minutes to build and verify. A video about it is coming soon", "None", {"Djo2x": "LoU1AbU8uCg"}),
    ("Ship Challenge", "123318508", "A level built for the challenge swap with Ylissen. We has 10 minutes to build and verify. A video about it is coming soon", "None", {"Ylissen": "", "Djo2x": "LoU1AbU8uCg"}),
    ("Wave Challenge Y", "123321027", "A level built for the challenge swap with Ylissen. We has 10 minutes to build and verify. A video about it is coming soon", "None", {"Ylissen": "", "Djo2x": "LoU1AbU8uCg"}),
    ("Spider Challenge", "123439088", "A level built for the challenge swap with Ylissen. We has 10 minutes to build and verify. A video about it is coming soon", "None", {"Ylissen": "", "Djo2x": "LoU1AbU8uCg"}),
    ("UFO Challenge", "123320075", "A level built for the challenge swap with Ylissen. We has 10 minutes to build and verify. A video about it is coming soon", "None", {"Ylissen": "", "Djo2x": "LoU1AbU8uCg"}),
    ("Robot Challenge", "123439077", "A level built for the challenge swap with Ylissen. We has 10 minutes to build and verify. A video about it is coming soon", "None", {"Ylissen": "", "Djo2x": "LoU1AbU8uCg"}),
    ("Ball Challenge", "123319310", "A level built for the challenge swap with Ylissen. We has 10 minutes to build and verify. A video about it is coming soon", "None", {"Ylissen": "", "Djo2x": "LoU1AbU8uCg"}),
